...
PerspectiveMapper::PerspectiveMapper(cv::Size& input_size,
                                     cv::Size& output_size)
...
void PerspectiveMapper::transformPerspective(cv::Mat& input)
{
    ...
    cv::warpPerspective(input, input, perspective_mat_, input_size_,
